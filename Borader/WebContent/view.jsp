	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle collapsed"
				...
				<a class="navbar-brand" href="main.jsp">JSP 게시판 (유기현 11주차과제)</a>
		</div>
		...
		<div class="row">
			<table class="table table-striped" style="text-align : center; border :1px solid=#dddddd">
				...
				<tbody>
					...
					<tr>
						<td>작성일자</td>
						<td colspan="2"><%= bbs.getBbsDate().substring(0,11)+bbs.getBbsDate().substring(11, 13)+"시"+bbs.getBbsDate().substring(11, 13)+"분" %></td>
					</tr>
					<tr>
						<td>내용</td>
